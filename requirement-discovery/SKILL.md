...
| 检查项 | 问题 | 评估 |
|--------|------|------|
| **效果预期** | AI 能达到用户期望的效果吗？ | ✅ 能 / ⚠️ 部分能 / ❌ 不能 |
| **数据依赖** | 需要什么数据？我们有吗？ | ✅ 有 / ⚠️ 需获取 / ❌ 无法获取 |
| **模型能力** | 现有模型能支持吗？ | ✅ 能 / ⚠️ 需调优 / ❌ 不能 |
| **响应时间** | 能在用户可接受的时间内响应吗？ | ✅ 能 / ⚠️ 边界 / ❌ 太慢 |
| **成本可控** | Token 成本在预算内吗？ | ✅ 可控 / ⚠️ 边界 / ❌ 太贵 |
| **内容安全** | 有内容安全风险吗？ | ✅ 安全 / ⚠️ 需审核 / ❌ 高风险 |
